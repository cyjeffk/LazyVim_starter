" NOTE: NOT identical to the orignal file on the Web
" Vim syntax file
" Language:	OCEAN
...
syn keyword oceanSimulation 	ac analysis appendPath converge
syn keyword oceanSimulation 	createNetlist connectRules
syn keyword oceanSimulation 	dc definitionFile delete desVar
syn keyword oceanSimulation 	design	discipline displayNetlist envOption
syn keyword oceanSimulation 	forcenode ic includeFile modelFile
syn keyword oceanSimulation 	nodeset	noise ocnCloseSession ocnDisplay
syn keyword oceanSimulation 	globalSignal globalSigAlias off	option
syn keyword oceanSimulation 	path prependPath restore resultsDir
syn keyword oceanSimulation 	run save saveOption simulator
syn keyword oceanSimulation 	solver stimulusFile store temp
syn keyword oceanSimulation 	tran vcdInfoFile vcdFile vecFile
syn keyword oceanSimulation 	evcdFile evcdInfoFile relxOption ocnAmsSetOSSNetlister

syn keyword oceanDataAccess 	dataTypes dcmatchSummary getData getResult
syn keyword oceanDataAccess 	i noiseSummary ocnHelp ocnPrint
syn keyword oceanDataAccess 	openResults outputParams outputs phaseNoise
syn keyword oceanDataAccess 	pv report resultParam results
syn keyword oceanDataAccess 	selectResult sp sweepNames sweepValues
syn keyword oceanDataAccess 	sweepVarValues v vswr zm
syn keyword oceanDataAccess 	zref pzSummary ocnResetResults

syn keyword oceanPlotting 	addSubwindowTitle addSubwindow addTitle
syn keyword oceanPlotting 	addWaveLabel addWindowLabel clearAll clearSubwindow
syn keyword oceanPlotting 	currentSubwindow currentWindow dbCompressionPlot
syn keyword oceanPlotting 	deleteSubwindow	deleteWaveform displayMode graphicsOff
syn keyword oceanPlotting 	graphicsOn hardCopy hardCopyOptions ip3Plot
syn keyword oceanPlotting 	newWindow plot plotStyle removeLabel
syn keyword oceanPlotting 	xLimit yLimit pzPlot
syn keyword oceanPlotting 	ocnWaveformTool ocnSetAttrib
syn keyword oceanPlotting 	awvGetCurrentWindow awvGetCurrentSubwindow
...
syn keyword oceanFileFunctions 	sprintf print
